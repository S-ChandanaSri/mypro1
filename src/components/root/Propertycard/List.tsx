            ...
            <div className="flex flex-col gap-8 w-full ">
              ...
              {list?.map((items, index) => (
                  <Card
                      ...
                      rate={'Good'}
                      ratepoint={'3.7'}
                      icons={[  roomViewSvgIcons.roomWifi,roomViewSvgIcons.roomTv,roomViewSvgIcons.roomCloud]}
                      ...
                      price="Rs 10,000"
                      multiImage={true}
                      detailsstyle={'w-full lg:h-38  justify-between  lg:relative lg:right-[6rem] bottom-9 flex flex-col gap-1 '}
                      titlestyle={'text-lg'}
                      ...
                      butonstyle={'w-[15rem] h-10 border-[1px] border-neutral-950 rounded-md'}
                      pricestyle={'text-md flex flex-row justify-between items-center mt-9 '}
                      wrapstyle={'absolute top-14'}
                      ratepointstyle={'flex gap-1 bg-[#3D52A0] text-neutral-50 p-1 items-center text-sm'}
              ...
              {cards.map((card, index) => (
                  <React.Fragment key={index}>
                    <Card
                        ...
                        buttonstyle={'pr-[140px] pb-[1rem] relative left-[1rem] flex justify-end'}
