                ...
                <div className='flex flex-col items-center'>
                    ...
                    >
                        <div className='flex items-center pt-5 w-[620px] h-[74px] gap-[161px]'>
                            ...
                            <Image width={58} height={58} src={house} className='w-[58px] h-[58px]' />
                        </div>
                    </button>
                    <button
                    ...
                    >
                        <div className='flex items-center pt-2 w-[620px] h-[74px] gap-[161px]'>
                            ...
                            <Image width={58} height={58} src={cilroom} className='w-[58px] h-[58px]' />
                        </div>
                    </button>
                    <button
                    ...
                    >
                        <div className='flex items-center pt-5 w-[620px] h-[74px] gap-[161px]'>
                            ...
                            <Image width={58} height={58} src={room} className='w-[58px] h-[58px]' />
                        </div>
                    </button>
                </div>
            </div>
