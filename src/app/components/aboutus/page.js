...
export default function Aboutus() {
  ...
  return (
    <div className='bg-[#FFFFFF]  sm:overflow-x-hidden '>
    ...
    <div className='flex flex-col items-center h-[1024px] sm:w-auto sm:h-[934px] '>
        <div className='w-[1066px] h-[449px] top-[140px]  '>
            <div className='flex flex-col items-center w-[1066px] h-[449px] relative top-[140px] gap-[11px] '>
                <div className='flex flex-col items-center w-[773px] h-[361px] w-fixed sm:w-auto  '>
                    ...
                    <p className='w-[670px] h-[233px] custom-font font-[400] text-[163px] leading-[233.2px] text-[#002855] sm:w-[150px] sm:text-[140px] sm:relative sm:right-[13rem] md:text-[150px] md:w-[350px] md:relative md:right-[7rem] md:mx-auto lg:text-[140px] lg:relative lg:left-[3rem]  lg:w-[670px] '>ZENDEN</p>
                    <div className='flex justify-between w-[439px] h-[60px] text-[#3D52A0] sm:w-auto lg:w-auto '>
                        ...
                        <p  className='w-[211px] h-[60px] top[301px] left-[395px] custo-font font-[500] text-[40px] leading-[60px] text-[#3D52A0] sm:relative sm:left-[1rem]  lg:relative lg:left-[10px]  '>Feel Home</p>
                    </div>
                </div>
                <p className='lg:w-[1066px] h-[77px] custo-font font-[300] text-[26px] leading-[39px] text-[#000000] pt-[4px] relative text-center sm:px-[48px] sm:w-[800px] sm:text-[20px] lg:text-[26px] '> ZenDen is reshaping student accommodation by offering affordable, comfortable and luxurious living spaces.</p>
            </div>
        </div>
        ...
        <div className='flex items-center justify-center flex-wrap gap-8  sm:gap-[50px]  sm:w-auto  sm:h-auto p-4 sm:relative sm:top-[230px] sm:left-[3rem]   '>
    ...
    <div className='h-[996px] top-[1024px]'>
        <div className='h-[996px] flex flex-col items-center '>
            ...
            <div className='grid grid-cols-3 gap-4 w-[1303px] h-[550px] relative top-[70px] py-[4px] px-[43px] sm:grid sm:grid-cols-1 sm:w-auto sm:h-[100%] sm:place-items-center sm:pr-[9rem] lg:grid lg:grid-cols-3    '>
                <div className='flex flex-col items-center w-[330px] h-[385px]  '>
                    ...
                    <p className='w-[330px] h-[78px] relative top-[125px] left-[43px] jakarta-font font-[400] text-[16px] leading-[26px] text-[#52525B] text-center lg:w-[280px] lg:text-[14px] xl:w-[330px] xl:text-[16px]'>Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
                </div>
                <div className='flex flex-col items-center w-[330px] h-[385px] '>
    ...
    <div className='flex flex-col items-center h-[1096px] relative top-[10px]  sm:w-auto sm:flex sm:items-center sm:h-[1096px] sm:pt-[88rem] lg:w-auto lg:flex lg:items-center lg:pt-[0rem] '>
        ...
        <div className='h-[1280px] pb-[106px] px-[32px] pt-[50px] sm:pt-[10rem] sm:w-auto sm:flex flex-col sm:items-center lg:h-[1280px] lg:w-auto '>
            <div className='flex  pb-[106px] px-[32px] sm:flex sm:justify-evenly   '  >
                <div className='flex flex-col items-center w-[384px] w-fill h-[106px] gap-[20px] sm:w-[170px] sm:relative left-[0rem] lg:pr-[15rem] lg:w-[270px] xl:w-[384px]'>
                ...
                <div className='flex flex-col items-center w-[384px] w-fill h-[106px] gap-[20px]  lg:pr-[7rem] sm:w-[170px] sm:relative sm:left-[3rem] lg:w-[270px] xl:w-[384px]'>
                <div  className='flex flex-col items-center  w-[384px] w-fill h-[62px] gap-[4px]  '> 
                ...
                <div className='flex flex-col items-center w-[384px] w-fill h-[106px] gap-[20px] sm:pr-[14rem] lg:pr-[8rem] sm:w-[170px] sm:relative sm:left-[10rem] lg:w-[270px] xl:w-[384px]'>
                <div  className='flex flex-col items-center w-[384px] w-fill h-[62px] gap-[4px]  '> 
    ...
    <p className='w-[391px] h-[64px] relative top-[10px] left-[530px] custo-font font-[400] text-[40px] leading-[64px] text-[#002855] text-center sm:relative sm:left-[20px] sm:w-auto sm:top-[78rem] lg:w-[391px] lg:h-[64px] lg:relative lg:top-[5rem] lg:left-[4rem] lg:mx-auto '>Our creative minds</p>



    <div className=' relative top-[80px] pb-[96px] lg:h-[80rem]  '>
        <div className=' grid grid-cols-4 gap-4 h-[1052px] px-[32px] sm:grid sm:grid-cols-1 sm:items-center sm:h-auto sm:relative sm:top-[80rem] lg:grid lg:grid-cols-4 lg:my-auto lg:relative lg:top-[3rem]  '>
    ...
    <div className='bg-[#F6F9FF] h-[977px] flex flex-col items-center rounded-[4px] py-[92px] px-[128px] gap-[56px] sm:relative sm:top-[85rem] md:relative md:bottom-[1rem] lg:relative lg:top-[-4rem] '>
...
<div className='w-[1184px] h-[173px] gap-[24px] sm:w-[100%] sm:h-[250px] '>
        ...
        <div className='flex items-center w-[1184px] h-[51px] gap-[80px] pt-[30px] sm:pt-[110px] sm:flex  sm:items-center  sm:w-[700px] md:w-[900px] md:relative md:right-[2rem] sm:relative sm:right-[7rem] xl:flex xl:relative xl:left-[4rem]'>
...
<div className='w-[137.33px] h-[248px] flex flex-col gap-[24px] sm:relative sm:left-[9rem] lg:relative lg:left-[3rem]'>
