    ...
    <>
      <div className="flex h-[575px] relative bottom-[80px]">
        <div className="w-[568px] h-[136px] relative top-[310px] left-[140px] ">
          <p className="custo-font text-[45px] font-[500] leading-[67.5px] tracking-[0.46px] text-[#000000] text-center">
        ...
        <div className="flex flex-col items-center justify-between ">
          <div className="w-[623px] h-[115.07px] relative left-[250px] top-[100px] flex ">
            <div className="w-[448px] h-[107px] ">
              <p className="w-[448px] h-[53px] custo-font text-[35px] font-[400] leading-[52.5px] tracking-[0.46px] text-[#000000] text-left">
                1.Tell us about your place
              </p>
              <p className=" w-[394px] h-[54px] custo-font text-[18px] font-[300] leading-[27px] tracking-[0.46px] text-[#000000] text-left">
