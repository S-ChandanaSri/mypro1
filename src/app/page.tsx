      ...
      <div className="bg-[#FFFFFF] h-screen overflow-x-hidden  ">
        ...
        >
          <div className="flex justify-between items-center  h-[72px]  pt-[15px] pr-[45px] pb-[15px] pl-[55px] shadow-[0px_-1px_1px_0px_#0000001A_inset]  md:h-[92px]  ">
            ...
            <button
              className="md:hidden md:top-0 md:right-0 p-4 z-50"
            ...
            <div className="transition-all duration-500 ease-in-out flex mt-12 ml-[2rem] items-center w-[301px] w-fixed h-[66px] h-fixed gap-[7px] p-[18px] relative right-[27rem] top-[5rem] rounded-[61.05px] bg-[#FFFFFF] xxs:ml-[9rem] xs:ml-[13rem] sm:mx-auto sm:ml-[27rem] sm:w-[501px] md:relative md:mx-auto md:left-[5rem] lg:relative lg:left-[5rem] lg:mx-auto ">
              ...
              <div className="flex w-[313px] h-[30px] items-center pt-2 ">
                ...
                <input
                  ...
                  className="relative focus:outline-none  bottom-[4px] w-[163px] h-[30px] font-poppins font-normal text-[18px] sm:text-[20px] leading-[30px] text-blue-custom text-opacity-80"
                />
              </div>
            </div>
          </div>
        ...
        <div className="h-[950px] top-[887px] px-[37px] py-[3px] gap-[32px] bg-[#C1C7DC] bg-opacity-10 sm:h-auto sm:mx-auto ">
          <div className="flex justify-between items-center  sm:flex sm:justify-around sm:items-center sm:relative sm:mx-auto sm:left-3 md:flex md:justify-between ">
            <div className=" h-[100px ] flex-col justify-between  sm:mx-auto md:mx-2 ">
              <p className="w-[281px] h-[38px] top-[2px] custo-font font-normal text-[13px] leading-[37.8px] text-[#000000] xxs:text-[15px] xxs:ml-6 xs:text-[16px] xs:ml-9 sm:relative sm:text-left sm:text-[16px] lg:text-[28px] transition-all duration-300 ">
                Our Popular Homes
              </p>
              <div className="w-[530px] h-[30px] ">
                <p className="w-[540px] h-[30px] custo-font font-[300] text-[12px] leading-[29.7px] text-[#000000] xxs:text-[14px] xxs:ml-6 xs:text-[15px] xs:ml-9 sm:h-auto sm:relative sm:text-left sm:text-[16px] lg:text-[22px] transition-all duration-300 ">
            ...
            <div className="flex items-center sm:relative sm:flex top-[0.5rem] sm:right-[3rem] sm:mx-auto  md:mx-2 ">
              <p className="w-[134px] h-[38px] custo-font font-[300] text-[28px] leading-[37.8px] items-center text-black  sm:h-auto sm:relative sm:text-left sm:text-[16px] lg:text-[22px] transition-all duration-300  ">
                Explore All
              </p>
              <button>
                <Image
                  ...
                  src={makiarrow}
                  alt=""
                  className="w-[31px] h-[31px] relative right-0 "
                />
              </button>
            </div>
          </div>
        ...
        <div className="h-[613px]  py-[20px] gap-[29px] relative top-[132rem] flex flex-col items-center sm:relative sm:top-[7rem] lg:relative lg:top-[4rem]  ">
          <div className="h-[77px] w-fixed flex flex-col items-center pl-[150px]  ">
            <p className="w-[440px] h-[57px] custo-font font-[400] text-[28px] pr-[11rem] leading-[57px] items-center xs:relative xs:left-[5rem] xs:text-[32px] xs:w-[600px] sm:text-[38px] sm:w-[638px] sm:mr-[2rem] lg:text-[38px] lg:mr-[0rem] xl:text-[38px] xl:mr-[0rem]  ">
              Book in 4 easy steps
            </p>
            <p className="w-[320px] h-[20px] custo-font font-[400] text-[12px] leading-[19.5px] items-center mr-[8rem] xs:text-[11px] xs:relative xs:left-[1rem] xs:w-auto xs:pr-[4rem] pt-2 sm:ml-3 sm:text-[15px] sm:w-[638px] lg:text-[15px] lg:mr-[2rem] xl:text-[15px] xl:mr-[6rem]">
          ...
          <div className="grid grid-cols-1 gap-[10px]   pt-[30px] sm:grid sm:grid-cols-2 sm:gap-4 sm:w-auto lg:grid lg:grid-cols-4 sm:place-items-center ">
            <div className="w-[310px] h-[467px] rounded-[20px] border-[3px] border-[#C1C7DC] sm:w-[260px] md:w-[310px] lg:w-[245px]  lg:mx-auto  xl:w-[310px]   ">
              ...
              <p className="w-[279px] h-[64px] top-[30px] custo-font font-[500] text-[21px] leading-[31.5px] relative pl-[38px] pb-[15px] text-center sm:pr-[3rem] md:ml-[1rem] lg:mr-[4rem] xl:pl-[4rem] xl:w-auto ">
                Discover verified properties
              </p>
              <p className="w-[290px] h-[119px] top-[30px] custo-font font-[400] text-[16px] leading-[24px] relative pt-[30px] pl-[6px] text-center sm:w-[240px] md:ml-[2rem] lg:relative lg:right-[2rem] lg:w-[240px] xl:w-[290px]">
            ...
            <div className="w-[310px] h-[467px] rounded-[20px] border-[3px] border-[#C1C7DC] sm:w-[260px] sm:ml-[4rem] md:w-[310px] lg:w-[245px] lg:mx-auto xl:w-[310px] ">
              ...
              <p className="w-[268px] h-[64px] top-[30px] custo-font font-[500] text-[21px] leading-[31.5px] relative pl-[38px] pb-[15px] text-center sm:pr-[3rem] md:ml-[1rem] lg:pr-[3rem] xl:pl-[4rem] xl:w-auto">
                Discover verified properties
              </p>
              <p className="w-[290px] h-[119px] top-[30px] custo-font font-[400] text-[16px] leading-[24px] relative pt-[30px] pl-[6px] text-center sm:w-[240px] md:ml-[2rem] lg:relative lg:right-[2rem] lg:w-[240px] xl:w-[290px]">
                Student accommodation is often located close to campus, saving
            ...
            <div className="w-[310px] h-[467px] rounded-[20px] border-[3px] border-[#C1C7DC] sm:w-[260px] sm:ml-[4rem] md:w-[310px] lg:w-[245px] lg:mx-auto xl:w-[310px]  ">
              ...
              <p className="w-[290px] h-[119px] top-[30px] custo-font font-[400] text-[16px] leading-[24px] relative pt-[30px] pl-[6px] text-center sm:w-[240px] md:ml-[2rem] lg:w-[240px] lg:relative lg:right-[2rem] xl:w-[290px] ">
                Student accommodation is often located close to campus, saving
                time on commutes and making it easier to get to classes and
                activities
              </p>
          ...
          <div className="grid grid-cols-1 gap-[10px]  pt-3 pl-3 sm:grid sm:grid-cols-2 sm:gap-4 sm:w-auto lg:grid lg:grid-cols-4 ">
            <div className=" h-[295px]  rounded-[20px] border-[2px] border-[#C1C7DC] sm:w-[260px] md:w-[310px] lg:w-[245px]  lg:mx-auto xl:w-[310px]  ">
              <Image
                ...
                src={ellipse11}
                alt=""
                className="w-[113px] h-[113px] relative left-[79px] top-[50px] sm:pr-[1rem] md:ml-[1rem] lg:left-auto lg:right-[-4rem] xl:pl-[1rem] xl:w-auto"
              />
              <p className="w-[205px] h-[38px] custo-font font-[400] text-[25px] leading-[37.5px] text-center relative left-[38px] top-[65px] sm:pr-[3rem] md:ml-[1rem] lg:left-auto lg:right-[-2rem] xl:pl-[0.1rem] xl:w-auto">
                Communication
              </p>
            </div>
            <div className=" h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC] sm:w-[260px] md:w-[310px] lg:w-[245px]  lg:mx-auto xl:w-[310px] ">
              <Image
                ...
                src={ellipse12}
                alt=""
                className="w-[113px] h-[113px] pl-2 relative left-[70px] top-[50px] sm:left-auto sm:right-[-4rem] md:ml-[2rem] lg:relative lg:left-[1.5rem] xl:pl-[2.5rem] xl:w-auto"
              />
              <p className="w-[205px] h-[38px] custo-font font-[400] text-[25px] text-center leading-[37.5px] relative left-[35px] top-[65px] sm:pr-[3rem] md:ml-[2rem] lg:relative lg:left-[1rem] xl:pl-[0.1rem] xl:w-auto">
                Realibility
              </p>
            </div>
            <div className=" h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC] sm:w-[260px] md:w-[310px] lg:w-[245px]  lg:mx-auto xl:w-[310px] ">
              <Image
                ...
                src={ellipse13}
                alt=""
                className="w-[125px] h-[113px] pl-3 relative left-[75px] top-[50px] sm:left-auto sm:right-[-3rem] md:ml-[2rem] lg:relative lg:left-[1.5rem] xl:pl-[2.5rem] xl:w-auto"
              />
              <p className="w-[205px] h-[38px] custo-font font-[400] text-[25px] leading-[37.5px] text-center relative left-[40px] top-[65px] sm:pr-[3rem] md:ml-[2rem] lg:relative lg:left-[1rem] xl:pl-[0.1rem] xl:w-auto">
                Quality First
              </p>
            </div>
            <div className="w-[260px] h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC] sm:w-[260px] md:w-[310px] lg:w-[245px]  lg:mx-auto xl:w-[310px] ">
              <Image
                ...
                src={ellipse14}
                alt=""
                className="w-[140px] h-[113px] relative pl-2 left-[59px] top-[50px] sm:left-auto sm:right-[-3rem] md:ml-[2rem]  lg:relative lg:left-[1.5rem] xl:pl-[2.5rem] xl:w-auto"
              />
              <p className="w-[205px] h-[38px] custo-font font-[400] text-center text-[25px] leading-[37.5px] relative left-[29px] top-[65px] sm:pr-[3rem] md:ml-[2rem] lg:relative lg:left-[1rem] xl:pl-[0.1rem] xl:w-auto">
                Student Friendly
              </p>
            </div>
          </div>
        ...
        <div className="h-[613px] px-[52px] py-[20px] gap-[29px] relative top-[283rem] flex flex-col items-center xxs:relative xxs:left-[4rem] sm:relative sm:flex sm:items-center sm:mt-[-217rem] lg:relative lg:mt-[-275rem] ">
          <div className="h-[77px] w-fixed pl-[430px] flex flex-col items-center xxs:relative xxs:right-[3rem]   ">
            <p className="w-[570px] h-[57px] custo-font font-[400] text-[28px] relative right-[2rem] leading-[57px] xs:text-[32px] xs:mr-8 items-center sm:flex sm:items-center lg:mr-[0rem] lg:text-[36px] ">
              Why Choose Us
            </p>
            <p className="w-[355px] h-[20px] custo-font font-[400] text-[11px] relative right-[12rem] text-center leading-[19.5px] xs:text-[15px] items-center pr-[50px] pt-2 sm:flex sm:items-center sm:relative sm:right-[11rem] sm:w-[600px] lg:text-[15px] ">
              Hassle free with prioritize security,and peace of mind for
            ...
            <div className="w-[310px] h-[467px] rounded-[20px] border-[3px] border-[#C1C7DC] sm:w-[260px] md:w-[310px] lg:w-[245px]  lg:mx-auto  xl:w-[310px]">
              <div className="w-[113px] h-[113px] relative top-[35px] left-[100px] sm:relative sm:left-[5rem] md:relative md:left-[7rem]">
                <Image
                  ...
                  height={94}
                  alt=""
                  className="w-[94px] h-[94px] sm:"
                />
              </div>
              <p className="w-[258px] h-[64px] top-[30px] custo-font font-[500] text-[21px] text-center leading-[31.5px] relative pl-[38px] pb-[15px] sm:pr-[3rem] md:ml-[1rem] lg:mr-[4rem] xl:pl-[4rem] xl:w-auto ">
                Convenience and Social Life
              </p>
              <p className="w-[290px] h-[119px] top-[30px] custo-font font-[400] text-[16px] text-center leading-[24px] relative pt-[30px] pl-[6px] sm:w-[240px] md:ml-[2rem] lg:relative lg:right-[2rem] lg:w-[240px] xl:w-[290px]">
                Student accommodation is often located close to campus, saving
                time on commutes and making it easier to get to classes and
                activities
              </p>
            ...
            <div className="w-[310px] h-[467px] rounded-[20px] border-[3px] border-[#C1C7DC] sm:w-[260px] md:w-[310px] lg:w-[245px]  lg:mx-auto  xl:w-[310px]">
              <div className="w-[113px] h-[113px] relative top-[35px] left-[100px] md:relative md:left-[7rem]">
                <Image
                  ...
                  src={ellipse12}
                  alt=""
                  className="w-[94px] h-[94px] sm:relative sm:right-[1rem] "
                />
              </div>
              <p className="w-[258px] h-[64px] top-[30px] custo-font font-[500] text-[21px] text-center leading-[31.5px] relative pl-[38px] pb-[15px] sm:pr-[3rem] md:ml-[1rem] lg:mr-[4rem] xl:pl-[4rem] xl:w-auto ">
                Hassle-free living
        ...
        <div className="w-auto relative top-[375rem] flex flex-col items-center left-[3rem] sm:left-[5rem] xxs:relative xxs:left-[4rem] sm:relative sm:mt-[-57rem] lg:relative lg:mt-[-87rem] mr-[8rem] ">
          <div className="h-[83px] flex flex-col items-center ">
            <p className=" w-[300px] h-[50px] custo-font font-[400] text-[23px] relative left-[4rem] sm:mr-[5rem] leading-[49.5px] sm:text-[33px] lg:text-[33px] ">
              Get in touch with Us
            </p>
            <p className="h-[33px] custo-font font-[400] text-[14px] leading-[33px] sm:text-[22px] lg:text-[22px] relative left-[1rem] ">
          ...
          <div className="grid grid-cols-1 gap-[10px]  pt-9 relative right-[2.5rem] sm:grid sm:grid-cols-2 xxs:relative xxs:left-[1rem]  sm:w-auto sm:relative sm:right-[1rem]  lg:grid lg:grid-cols-4">
            <div className="w-[310px] h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC] sm:w-[260px] md:w-[310px] lg:w-[245px]  lg:mx-auto xl:w-[310px] ">
              <Image
                ...
                src={ellipse15}
                alt=""
                className="w-[113px] h-[113px] relative left-[85px] top-[50px] sm:left-auto sm:right-[-4rem] md:ml-[2rem] lg:relative lg:left-[1.5rem] xl:pl-[2.5rem] xl:w-auto "
              />
              <p className="w-[205px] h-[38px] custo-font font-[400] text-[25px] leading-[37.5px] relative left-[110px] top-[65px] sm:relative sm:left-[5rem] md:ml-[2rem] lg:left-[3rem] xl:pl-[2rem]">
                call us
              </p>
            </div>
            <div className="w-[310px] h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC] sm:w-[260px] md:w-[310px] lg:w-[245px]  lg:mx-auto xl:w-[310px] ">
              <Image
                ...
                src={ellipse16}
                alt=""
                className="w-[113px] h-[113px] relative left-[100px] top-[50px] sm:left-auto sm:right-[-4rem] md:ml-[2rem] lg:relative lg:left-[1.5rem] xl:pl-[2.5rem] xl:w-auto"
              />
              <p className="w-[205px] h-[38px] custo-font font-[400] text-[25px] leading-[37.5px] relative left-[110px] top-[65px] sm:left-[5rem]  md:ml-[1rem]  lg:left-[3rem] xl:pl-[2hrem] xl:w-auto ">
                Email Us
              </p>
            </div>
            <div className="w-[310px] h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC] sm:w-[260px] md:w-[310px] lg:w-[245px]  lg:mx-auto xl:w-[310px] ">
              <Image
                ...
                className="w-[113px] h-[113px] relative left-[100px] top-[50px] sm:left-auto sm:right-[-4rem] md:ml-[2rem] lg:relative lg:left-[1.5rem] xl:pl-[2.5rem] xl:w-auto"
              />
              <p className="w-[205px] h-[38px] custo-font font-[400] text-[25px] leading-[37.5px] relative left-[70px] top-[65px] sm:left-[2rem] sm:w-auto md:ml-[1 rem]  lg:right-[1rem] xl:pl-[1.5rem]">
                Chat on Whatsapp
              </p>
            </div>
            <div className="w-[310px] h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC] sm:w-[260px] md:w-[310px] lg:w-[245px]  lg:mx-auto xl:w-[310px] ">
              <Image
                ...
                className="w-[113px] h-[113px] relative left-[100px] top-[50px] sm:left-auto sm:right-[-4rem] md:ml-[2rem] lg:relative lg:left-[1.5rem] xl:pl-[2.5rem] xl:w-auto"
              />
              <p className="w-[205px] h-[38px] custo-font font-[400] text-[25px] leading-[37.5px] relative left-[70px] top-[65px] sm:left-[3rem]  md:ml-[1rem] lg:left-auto lg:right-[-1rem] xl:pl-[1.5rem] xl:w-auto  ">
                Chat on Website
              </p>
            </div>
          </div>
        ...
        <div className=" h-[1099x] py-[106px] gap-[71px] pt-[125px] relative top-[375rem] sm:relative sm:flex sm:flex-col sm:items-center sm:mt-[-5rem]  lg:relative lg:mt-[-7rem] ">
          <div className=" h-[145px] gap-[23px] pt-11 flex flex-col items-center sm:mr-[29rem] lg:ml-[5rem] ">
            <p className=" h-[62px] custo-font font-[400] text-[28px] leading-[62px] relative right-[0rem] tracking-[-2px] text-[#090914] pt-2 sm:w-[600px] sm:relative sm:left-[14rem] sm:text-[52px] sm:ml-10  xl:relative xl:mr-[5rem] ">
              Over 1000+ people trust us
            </p>
            <p className=" h-[60px] custo-font font-[400] text-[13px] leading-[30px] text-gray-900 relative top-[20px] text-center sm:text-[18px] sm:w-[600px] sm:relative sm:left-[15rem] lg:right-[10rem] xl:relative xl:mr-[5rem]">
          ...
          <div className="w-[1280px] relative top-[461rem] xxs:relative xxs:left-[4rem] xs:relative xs:left-[8rem]   xl:relative xl:left-[22rem] flex flex-col items-center h-[94x] px-[32px] gap-[32px] sm:relative sm:top-[455rem] lg:relative lg:top-[378rem] lg:left-[15rem] ">
            <div className="w-[1216px] h-[94px] gap-[48px] ">
              <div className="w-[768px] h-[94px] gap-[20px] relative pl-[50px] ">
                <p className=" h-[44px] relative right-[4rem] custo-font font-[400] text-[13px] leading-[44px] tracking-[-2%] xs:text-[25px] xs:relative xs:right-[8rem] sm:text-left sm:mx-auto sm:text-[26px] lg:text-left lg:mx-auto lg:text-[30px] xl:text-left xl:mx-auto xl:text-[36px] transition-all duration-300">
                  Frequently asked questions
                </p>
                <p className="pt-[13px] relative right-[4rem] h-[30px] custo-font font-[400] text-[9px] leading-[28px] text-[#667085] xs:text-[12px] xs:relative xs:right-[8rem] sm:text-left sm:mx-auto sm:text-[16px] lg:text-left lg:mx-auto lg:text-[18px] transition-all duration-300 xl:text-left xl:mx-auto xl:text-[20px]">
          ...
          <div className="h-[294px]  gap-[32px] relative top-[460rem] xxs:relative xxs:right-[0rem] xs:relative xs:right-[0rem] sm:flex sm:items-center lg:flex lg:items-center lg:relative lg:top-[380rem] lg:right-[1rem] xl:relative xl:right-[1rem] md:ml-[9rem]  sm:relative sm:top-[455rem] ">
            <div className="flex flex-col items-center  h-[294px] rounded-[16px] p-[32px] gap-[32px] bg-[#F9FAFB]  sm:flex sm:items-center sm:mx-auto ">
              ...
              <div className="w-[768px] w-fixed h-[66px] text-center">
                ...
                <p className="w-[320px] h-[28px] custo-font font-[400] text-[12px] relative left-[14rem] leading-[28px] text-[#667085] ">
          ...
          <div className="flex w-[300px] xl:w-[1100px] lg:w-[984px] h-[272px] relative top-[24rem] justify-between sm:flex sm:justify-evenly sm:w-[900px] sm:relative sm:top-[0rem] sm:right-[2rem] md:w-[1100px] lg:flex lg:justify-between lg:pt-4  ">
            ...
            <div className="sm:w-[137.33px]  h-[272px] flex flex-col  gap-[24px] sm:relative sm:left-[3.8rem] lg:relative lg:left-[3rem]">
              ...
              <div className=" sm:w-[137.33px]   h-[200px] flex flex-col gap-[20px] ">
                ...
                <p className="sm:relative sm:right-[35px] relative sm:w-[137.33px] w-[80px]  h-[42px] text-[#4B5768] custo-font font-[500] text-[16px] leading-[24px]  ">
                  Manage Deliveries
                </p>
                <p className="flex sm:w-[137.33px] w-[80px]  h-[24px] text-[#4B5768] custo-font font-[500] text-[16px] leading-[24px]  ">
                  Orders
