  ...
  return (
    ...
    <div className='flex justify-between items-center  '>
       ...
       <div className='flex items-center '>
        ...
        <button>
        <Image width={31} height={31} src={makiarrow} alt='' className='w-[31px] h-[31px] pl-2'  />
        </button>
       </div>
    ...
    <div className='h-[613px] px-[52px] py-[20px] gap-[29px] top-[1837px] flex flex-col items-center '>
      ...
      <div className='flex items-center w-[1336px] w-fill h-[467px] gap-[82px] pt-[30px] '>
        <div className='w-[310px] h-[467px] rounded-[20px] border-[3px] border-[#C1C7DC]'>
          ...
          <p className='w-[258px] h-[64px] top-[30px] custo-font font-[500] text-[21px] leading-[31.5px] relative pl-[38px] pb-[15px] text-center '>Discover verified properties</p>
          <p className='w-[290px] h-[119px] top-[30px] custo-font font-[400] text-[16px] leading-[24px] relative pt-[30px] pl-[6px] text-center '>Student accommodation is often located close to campus, saving time on commutes and making it easier to get to classes and activities</p>
        </div>
        <div className='w-[310px] h-[467px] rounded-[20px] border-[3px] border-[#C1C7DC]'>
          <div className='w-[113px] h-[113px] relative top-[35px] left-[100px] '>
    ...
    <div className=' w-fill h-[402px] gap-[57px] pt-9  flex flex-col items-center '>
      ...
      <div className='flex h-[295px] gap-[61px] pt-3 pl-11 '>
        <div className='w-[310px] h-[295px]  rounded-[20px] border-[2px] border-[#C1C7DC]  '>
          <Image width={113} height={113} src={ellipse11} alt='' className='w-[113px] h-[113px] relative left-[85px] top-[50px] ' />
          <p className='w-[205px] h-[38px] custo-font font-[400] text-[25px] leading-[37.5px] text-center relative left-[50px] top-[65px]  '>Communication</p>
        </div>
        <div className='w-[310px] h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC]   '>
          <Image width={113} height={113} src={ellipse12} alt='' className='w-[113px] h-[113px] pl-2 relative left-[85px] top-[50px] ' />
          <p className='w-[205px] h-[38px] custo-font font-[400] text-[25px] text-center leading-[37.5px] relative left-[50px] top-[65px]  '>Realibility</p>
        </div>
        <div className='w-[310px] h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC]  '>
          <Image width={113} height={113} src={ellipse13} alt='' className='w-[125px] h-[113px] pl-3 relative left-[85px] top-[50px] ' />
          <p className='w-[205px] h-[38px] custo-font font-[400] text-[25px] leading-[37.5px] text-center relative left-[50px] top-[65px]  '>Quality First</p>
        </div>
        <div className='w-[310px] h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC]  '>
          <Image width={113} height={113} src={ellipse14} alt='' className='w-[120px] h-[113px] relative pl-2 left-[85px] top-[50px] ' />
          <p className='w-[205px] h-[38px] custo-font font-[400] text-center text-[25px] leading-[37.5px] relative left-[50px] top-[65px]  '>Student Friendly</p>
        </div>
      </div>
    ...
    <div className='h-[613px] px-[52px] py-[20px] gap-[29px] pt-[90px] '>
      <div className='h-[77px] w-fixed pl-[430px] flex flex-col items-center '>
        ...
        <p className='w-[725px] h-[20px] custo-font font-[400] text-[13x] leading-[19.5px] items-center pr-[50px] pt-2'>Hassle free with prioritize security,and peace of mind for students and their parents</p>
      </div>
      <div className='flex w-[1336px] w-fill h-[467px] gap-[82px] pt-[30px] '>
        <div className='w-[310px] h-[467px] rounded-[20px] border-[3px] border-[#C1C7DC]'>
          <div className='w-[113px] h-[113px] relative top-[35px] left-[100px] '>
            <Image  src={ellipse11} width={94} height={94} alt='' className='w-[94px] h-[94px]  '  />
          </div>
          <p className='w-[258px] h-[64px] top-[30px] custo-font font-[500] text-[21px] text-center leading-[31.5px] relative pl-[38px] pb-[15px]'>Convenience and Social Life</p>
          <p className='w-[290px] h-[119px] top-[30px] custo-font font-[400] text-[16px] text-center leading-[24px] relative pt-[30px] pl-[6px] '>Student accommodation is often located close to campus, saving time on commutes and making it easier to get to classes and activities</p>
        </div>
        <div className='w-[310px] h-[467px] rounded-[20px] border-[3px] border-[#C1C7DC]'>
          <div className='w-[113px] h-[113px] relative top-[35px] left-[100px] '>
            <Image width={94} height={94} src={ellipse12} alt='' className='w-[94px] h-[94px]  '  />
          </div>
          <p className='w-[258px] h-[64px] top-[30px] custo-font font-[500] text-[21px] text-center leading-[31.5px] relative pl-[38px] pb-[15px]'>Hassle-free living</p>
          <p className='w-[290px] h-[119px] top-[30px] custo-font font-[400] text-[16px] text-center leading-[24px] relative pt-[30px] pl-[6px] '>Student accommodation is often located close to campus, saving time on commutes and making it easier to get to classes and activities</p>
        </div>
        <div className='w-[310px] h-[467px] rounded-[20px] border-[3px] border-[#C1C7DC]'>
          <div className='w-[113px] h-[113px] relative top-[35px] left-[100px] '>
          ...
          <p className='w-[258px] h-[64px] top-[30px] custo-font font-[500] text-[21px] text-center leading-[31.5px] relative pl-[38px] pb-[15px]'>Safety and Security</p>
          <p className='w-[290px] h-[119px] top-[30px] custo-font font-[400] text-[16px] text-center leading-[24px] relative pt-[30px] pl-[6px] '>Student accommodation is often located close to campus, saving time on commutes and making it easier to get to classes and activities</p>
        </div>
        <div className='w-[310px] h-[467px] rounded-[20px] border-[3px] border-[#C1C7DC]'>
          <div className='w-[113px] h-[113px] relative top-[35px] left-[100px] '>
          ...
          <p className='w-[258px] h-[64px] top-[30px]  custo-font font-[500] text-[21px] text-center leading-[31.5px] relative  pl-[38px] pb-[15px]'>Support Services</p>
          <p className='w-[290px] h-[119px] top-[30px] custo-font font-[400] text-[16px] text-center leading-[24px] relative pt-[30px] pl-[6px] '>Student accommodation is often located close to campus, saving time on commutes and making it easier to get to classes and activities</p>
        </div>
      </div>
    </div>
    ...
    <div className=' w-fill h-[402px] gap-[57px] pt-[100px] '>
      ...
      <div className='flex h-[295px] gap-[61px] pt-8 pl-11  '>
        <div className='w-[310px] h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC]  '>
          <Image width={113} height={113} src={ellipse15} alt='' className='w-[113px] h-[113px] relative left-[85px] top-[50px] ' />
          <p className='w-[205px] h-[38px] custo-font font-[400] text-[25px] leading-[37.5px] relative left-[110px] top-[65px]   '>call us</p>
        </div>
        <div className='w-[310px] h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC]  '>
          <Image width={113} height={113}  src={ellipse16} alt='' className='w-[113px] h-[113px] relative left-[100px] top-[50px] ' />
          <p className='w-[205px] h-[38px] custo-font font-[400] text-[25px] leading-[37.5px] relative left-[110px] top-[65px]  '>Email Us</p>
        </div>
        <div className='w-[310px] h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC]  '>
          <Image width={113} height={113}  src={ellipse17} alt='' className='w-[113px] h-[113px] relative left-[100px] top-[50px] ' />
          <p className='w-[205px] h-[38px] custo-font font-[400] text-[25px] leading-[37.5px] relative left-[70px] top-[65px]  '>Chat on Whatsapp</p>
        </div>
        <div className='w-[310px] h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC]  '>
          <Image width={113} height={113}  src={ellipse18} alt='' className='w-[113px] h-[113px] relative left-[100px] top-[50px] ' />
          <p className='w-[205px] h-[38px] custo-font font-[400] text-[25px] leading-[37.5px] relative left-[70px] top-[65px]  '>Chat on Website</p>
        </div>
      </div>
    ...
    <div className=' h-[1099x] py-[106px] px-[172px] gap-[71px] pt-[125px]  '>
      <div className='w-[755px] h-[145px] gap-[23px] pt-11 flex flex-col items-center '>
        <p className=' h-[62px] custo-font font-[400] text-[52px] leading-[62px] tracking-[-2px] text-[#090914] relative left-[216px] pt-2 '>Over 1000+ people trust us</p>
    ...
    <div className='bg-[#F6F9FF] h-[977px] flex flex-col items-center rounded-[4px] py-[92px] px-[128px] gap-[56px] '>
      ...
      <div className='w-[1184px] h-[173px] gap-[24px]  '>
        <div className='w-[1184px] h-[98px] gap-[16px] '>
          <Image width={134} height={34} src={Logoz} alt='' className='w-[134px] h-[34px] pb-2 '   />
        ...
        <div className='flex items-center w-[1184px] h-[51px] gap-[80px] pt-[30px] '>
          <div className='flex w-[236px] w-fill h-fill h-[51px] gap-[12px] '>
            <Image width={32} height={32} src={icons} alt='' className='w-[32px] h-[32px] ' />
          ...
          <div className='flex w-[236px] w-fill h-fill h-[51px] gap-[12px] '>
          <Image width={32} height={32} src={mail} alt='' className='w-[32px] h-[32px] ' />
          <div className='w-[192px] h-[48px] gap-[2px] '>
          ...
          <div className='flex w-[236px] w-fill h-fill h-[51px] gap-[12px] '>
          <Image width={32} height={32} src={address} alt='' className='w-[32px] h-[32px] ' />
          <div className='w-[192px] h-[48px] gap-[2px] '>
          ...
          <Image width={32} height={32} src={fax} alt='' className='w-[32px] h-[32px] ' />
          <div className='w-[192px] h-[48px] gap-[2px]  '>
