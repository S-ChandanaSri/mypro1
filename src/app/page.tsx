...
// example usage of redux slices;
// reudx actions
import { exampleReducers } from "@/redux/features/exampleSlice";
...
function Home() {
  ...
  // using state data
  const exampleSliceValue = useAppSelector(
    (state: RootState) => state.exampleFeature.example
  );

  // using actions
  const dispatch = useAppDispatch();
  const exampleActions = () => {
    dispatch(exampleReducers("example reducer actions values"));
  };
  ...
  return <div>{exampleSliceValue}</div>;
  // return (
