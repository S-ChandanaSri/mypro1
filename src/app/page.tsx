...
const [menuOpen, setMenuOpen] = useState(false);
  ...
  return (
    <div className=' overflow-x-hidden overflow-y-auto '>
      ...
      <div className=' h-[730px] py-[156px] px-[418px]  gap-[40px] bg-[linear-gradient(180deg,_rgba(248,_247,_255,_0.02)_0%,_rgba(5,_7,_13,_0.48)_57.76%,_rgba(0,_0,_0,_0.82)_92.61%)] sm:py-[150px] sm:px-[80px] lg:py-[130px]'>
        <div className='w-[638px] w-fill h-[281x] h-fixed gap-[19px] mx-auto md:flex md:flex-col md:items-center'>
            <p className='text-[#E3F2FD]  foundation-blue-light w-[638px] h-[141px] custo-font font-[400] text-[56px] leading-[61.6px] items-center shadow-[5px_5px_10px_0px_#0000004D] text-center sm:text-[30px] sm:relative sm:right-[5rem] sm:mx-auto sm:pl-[9rem] sm:leading-[40px] sm:flex sm:items-center sm:text-center md:mx-auto md:relative md:left-[3rem] md:pl-[7rem] lg:text-[48px] lg:leading-[55px] sm:pt-8 sm:shadow-[1px_3px_6px_0px_#0000004D] lg:relative lg:right-[5rem] lg:pl-[3rem] lg:w-[678px] '>Reserve <span className='custo-font font-[400] text-[56px] leading-[61.6px] items-center sm:text-[36px] lg:text-[48px] sm:flex sm:items-center lg:text-center lg:w-auto '>your Ideal Holiday</span> </p>
            <p className=' w-[638px] mt-4 h-[61.4px] custo-font font-[400] text-[22px] leading-[27px] text-[#FFFFFF] items-center shadow-[5px_5px_10px_0px_#0000004D] pt-3 sm:flex sm:text-[18px] sm:items-center sm:relative sm:right-[4rem] sm:shadow-[3px_3px_6px_0px_#0000004D] pl-[5rem] md:relative md:left-[3rem]'>We're thrilled to have you! Let's find you the ideal place to stay.</p>
            <div className='flex mt-9 w-Fill [638px] h-[41px] h-fixed gap-[53px] sm:flex sm:items-center sm:relative sm:right-[4rem] sm:mx-auto md:flex md:items-center md:left-[3rem] '>
        ...
        <div className='flex mt-10 ml-14 items-center w-[501px] w-fixed h-[66px] h-fixed gap-[7px] p-[18px] rounded-[61.05px] bg-[#FFFFFF] sm:relative sm:mx-auto right-[1rem] md:relative md:mx-auto md:left-[5rem] lg:relative lg:left-[8rem] lg:mx-auto '> 
    ...
    <div className='flex justify-between items-center  sm:flex sm:justify-around sm:items-center sm:relative sm:mx-auto sm:left-3 md:flex md:justify-between '>
       ...
       <div className=' h-[100px ] flex-col justify-between  sm:mx-auto md:mx-2 '>
         <p className='w-[281px] h-[38px] top-[2px] custo-font font-normal text-[28px] leading-[37.8px] text-[#000000] sm:relative sm:text-left sm:text-[16px] lg:text-[28px] transition-all duration-300 '>Our Popular Homes</p>
          <div className='w-[530px] h-[30px] '>
             <p className='w-[540px] h-[30px] custo-font font-[300] text-[22px] leading-[29.7px] text-[#000000]  sm:h-auto sm:relative sm:text-left sm:text-[16px] lg:text-[22px] transition-all duration-300 '>Book student acomodation across popular cities</p>
          </div>
       </div>
      ...
      <div className=' h-[726px] sm:flex sm:flex-col sm:items-center '>
        <div className=' grid grid-cols-4 gap-4 sm:grid sm:grid-cols-2 sm:h-auto sm:mx-auto sm:justify-start lg:grid lg:grid-cols-4 lg:justify-between  lg:h-auto md:mx-auto md:grid-cols-2 md:justify-between  '>
         


            
            <div className='w-[306px] h-[341px] rounded-[13px] pt-4 pl-2  lg:w-[250px] xl:w-[306px]  '>
      ...
      <button className='h-[48px] pt-10 sm:relative sm:top-[43rem] sm:flex sm:justify-center sm:w-full  '>
      <div className='w-[170.43px] h-[48px] rounded-[4.17px]  text-[#000000] border border-[#4A61B5] lg:relative bottom-[41rem] '>
    ...
    <div className='h-[613px] px-[52px] py-[20px] gap-[29px] top-[1837px] flex flex-col items-center sm:relative sm:top-[47rem] lg:relative lg:top-[4rem]  '>
      <div className='h-[77px] w-fixed flex flex-col items-center pl-[150px]  '>
        <p className='w-[570px] h-[57px] custo-font font-[400] text-[38px] pl-[45px] leading-[57px] items-center'>Book in 4 easy steps</p>
      ...
      <div className='grid grid-cols-4  w-[1336px]   pt-[30px] sm:grid sm:grid-cols-2 sm:gap-4 sm:w-auto lg:grid lg:grid-cols-4 sm:place-items-center '>
    ...
    <div className=' w-fill h-[402px] gap-[57px] pt-9  flex flex-col items-center sm:relative sm:items-center sm:mt-[78rem] lg:relative lg:mt-[4rem] '>
      <p className='h-[50px] custo-font font-[400] text-[33px] leading-[49.5px] pt-7 '>Our services</p>
      <div className='grid grid-cols-4 h-[295px] gap-[61px] pt-3 pl-11 sm:grid sm:grid-cols-2 sm:gap-4 sm:w-auto lg:grid lg:grid-cols-4 '>
        <div className='w-[310px] h-[295px]  rounded-[20px] border-[2px] border-[#C1C7DC] sm:w-[260px] md:w-[310px] lg:w-[245px]  lg:mx-auto xl:w-[310px]  '>
          <Image width={113} height={113} src={ellipse11} alt='' className='w-[113px] h-[113px] relative left-[85px] top-[50px] sm:pr-[1rem] md:ml-[1rem] lg:left-auto lg:right-[-4rem] xl:pl-[1rem] xl:w-auto' />
          <p className='w-[205px] h-[38px] custo-font font-[400] text-[25px] leading-[37.5px] text-center relative left-[50px] top-[65px] sm:pr-[3rem] md:ml-[1rem] lg:left-auto lg:right-[-2rem] xl:pl-[0.1rem] xl:w-auto'>Communication</p>
        </div>
        <div className='w-[310px] h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC] sm:w-[260px] md:w-[310px] lg:w-[245px]  lg:mx-auto xl:w-[310px] '>
          <Image width={113} height={113} src={ellipse12} alt='' className='w-[113px] h-[113px] pl-2 relative left-[85px] top-[50px] sm:left-auto sm:right-[-4rem] md:ml-[2rem] lg:relative lg:left-[1.5rem] xl:pl-[2.5rem] xl:w-auto' />
          <p className='w-[205px] h-[38px] custo-font font-[400] text-[25px] text-center leading-[37.5px] relative left-[50px] top-[65px] sm:pr-[3rem] md:ml-[2rem] lg:relative lg:left-[1rem] xl:pl-[0.1rem] xl:w-auto'>Realibility</p>
        </div>
        <div className='w-[310px] h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC] sm:w-[260px] md:w-[310px] lg:w-[245px]  lg:mx-auto xl:w-[310px] '>
          <Image width={113} height={113} src={ellipse13} alt='' className='w-[125px] h-[113px] pl-3 relative left-[85px] top-[50px] sm:left-auto sm:right-[-3rem] md:ml-[2rem] lg:relative lg:left-[1.5rem] xl:pl-[2.5rem] xl:w-auto' />
          <p className='w-[205px] h-[38px] custo-font font-[400] text-[25px] leading-[37.5px] text-center relative left-[50px] top-[65px] sm:pr-[3rem] md:ml-[2rem] lg:relative lg:left-[1rem] xl:pl-[0.1rem] xl:w-auto'>Quality First</p>
        </div>
        <div className='w-[310px] h-[295px] rounded-[20px] border-[2px] border-[#C1C7DC] sm:w-[260px] md:w-[310px] lg:w-[245px]  lg:mx-auto xl:w-[310px] '>
          <Image width={113} height={113} src={ellipse14} alt='' className='w-[140px] h-[113px] relative pl-2 left-[85px] top-[50px] sm:left-auto sm:right-[-3rem] md:ml-[2rem]  lg:relative lg:left-[1.5rem] xl:pl-[2.5rem] xl:w-auto' />
          <p className='w-[205px] h-[38px] custo-font font-[400] text-center text-[25px] leading-[37.5px] relative left-[50px] top-[65px] sm:pr-[3rem] md:ml-[2rem] lg:relative lg:left-[1rem] xl:pl-[0.1rem] xl:w-auto'>Student Friendly</p>
        </div>
      </div>
    ...
    <div className='h-[613px] px-[52px] py-[20px] gap-[29px] pt-[90px] flex flex-col items-center sm:relative sm:flex sm:items-center sm:mt-[20rem] lg:relative lg:mt-[0rem] '>
      <div className='h-[77px] w-fixed pl-[430px] flex flex-col items-center  '>
        <p className='w-[570px] h-[57px] custo-font font-[400] text-[38px] leading-[57px] items-center sm:flex sm:items-center lg:mr-[10rem] '>Why Choose Us</p>
        <p className='w-[725px] h-[20px] custo-font font-[400] text-[13x] leading-[19.5px] items-center pr-[50px] pt-2 sm:flex sm:items-center sm:relative sm:right-[7rem] '>Hassle free with prioritize security,and peace of mind for students and their parents</p>
      </div>
      <div className='grid grid-cols-4 w-[1336px] w-fill h-[467px] gap-[82px] pt-[30px] sm:grid sm:grid-cols-2 sm:gap-4 sm:w-auto sm:relative sm:left-[2rem] lg:grid lg:grid-cols-4 '>
        <div className='w-[310px] h-[467px] rounded-[20px] border-[3px] border-[#C1C7DC] sm:w-[260px] md:w-[310px] lg:w-[245px]  lg:mx-auto  xl:w-[310px]'>
    ...
    <div className=' w-fill h-[402px] gap-[57px] pt-[100px] sm:relative sm:left-[5rem] sm:mt-[30rem] lg:relative lg:mt-[0rem] mr-[8rem] '>
      ...
      <div className='grid grid-cols-4 w-[1336px] h-[295px] gap-[61px] pt-8 pl-11  sm:grid sm:grid-cols-2  sm:w-auto sm:relative sm:right-[1rem]  lg:grid lg:grid-cols-4'>
    ...
    <div className=' h-[1099x] py-[106px] px-[172px] gap-[71px] pt-[125px] sm:relative sm:flex sm:flex-col sm:items-center sm:mt-[20rem] lg:relative lg:mt-[1rem] '>
      <div className='w-[755px] h-[145px] gap-[23px] pt-11 flex flex-col items-center sm:mr-[29rem] lg:ml-[10rem] '>
        <p className=' h-[62px] custo-font font-[400] text-[52px] leading-[62px] tracking-[-2px] text-[#090914] relative left-[216px] pt-2 sm:ml-10 '>Over 1000+ people trust us</p>
        <p className='w-[710px] h-[60px] custo-font font-[400] text-[18px] leading-[30px] text-gray-900 relative left-[236px] top-[20px] text-center '>Clarity gives you the blocks & components you need to create a truly professional website, landing page or admin panel for your SaaS.</p>
      </div>
      <div className='flex w-[1096px] h-[568px] gap-[90px] sm:flex-col sm:gap-[20px] sm:items-center lg:flex-row lg:ml-[4rem]  '>
      <VideoPlayer 
      ...
      <button className='w-[297px] h-[32px] rounded-[50px] gap-[10px] p-[16px] cursor-pointer sm:flex sm:justify-center sm:mt-[75rem] sm:relative sm:right-[30rem]  sm:items-center sm:w-full lg:absolute lg:left-1/4 lg:transform lg:bottom-[4rem] lg:-translate-x-1/2'>
    ...
    <div className='h-[1221px] pt-[180px]  py-[96px] gap-[64px] bg-white sm:flex flex-col sm:items-center  ' >
      <div className='w-[1280px] flex flex-col items-center h-[94x] px-[32px] gap-[32px] '>
        <div className='w-[1216px] h-[94px] gap-[48px] '>
          <div className='w-[768px] h-[94px] gap-[20px] relative pl-[350px] '>
            <p className='w-[768px]  h-[44px] custo-font font-[400] text-[36px] leading-[44px] tracking-[-2%] sm:text-left sm:mx-auto sm:text-[26px] lg:text-left lg:mx-auto lg:text-[30px] xl:text-left xl:mx-auto xl:text-[36px] transition-all duration-300'>Frequently asked questions</p>
            <p className='w-[768px] pt-[13px] h-[30px] custo-font font-[400] text-[20px] leading-[30px] text-[#667085] sm:text-left sm:mx-auto sm:text-[16px] lg:text-left lg:mx-auto lg:text-[18px] transition-all duration-300 xl:text-left xl:mx-auto xl:text-[20px]'>Everything you need to know about the student Accomodation and Housing</p>
          </div>
        </div>
      </div>
        ...
        <div key={item.id} className='w-[768px] h-[84px] gap-[24px]'>
          <div className='flex w-[768px] h-[84px] gap-[24px] justify-between '>
            <div className='w-[720px] w-fill h-[84px] gap-[18px] sm:text-center sm:mx-auto  transition-all duration-300'>
              <p className='flex text-[#101828] w-[720px] h-[px] custo-font font-[500] text-[18px] leading-[28px] pr-[210px] sm:text-left sm:mx-auto sm:text-[18px] lg:text-left lg:mx-auto lg:text-[18px] xl:text-left xl:mx-auto xl:text-[18px] transition-all duration-300 '>
                {item.question}
              </p>
              {isOpen[index] && (
                <p className='flex text-left  text-[#667085] w-[720px] h-[48px] custo-font font-[400] text-[16px] leading-[24px]  sm:mr-[11rem] sm:mx-auto sm:text-[12px] sm:w-[580px] lg:w-[580px] lg:mr-[11rem] lg:text-left lg:mx-auto lg:text-[14px] xl:w-[720px] xl:mr-[11rem] xl:text-left xl:mx-auto xl:text-[16px] transition-all duration-300 '>
                  {item.answer}
                </p>
              )}
            </div>
            <Image width={24} height={24}
              ...
              className='w-[24px] h-[24px] cursor-pointer sm:mx-auto sm:relative sm:right-[12rem] xl:relative xl:left-[1rem]  '
      ...
      <div className=' w-[1280px] h-[294px] px-[100px] gap-[32px] sm:flex sm:items-center lg:flex lg:items-center '>
      <div className='flex flex-col items-center w-[1326px] h-[294px] rounded-[16px] p-[32px] gap-[32px] bg-[#F9FAFB]  sm:flex sm:items-center sm:mx-auto '>
    ...
    <div className='flex flex-col lg:flex-row w-[1184px] h-auto rounded-[12px] py-[28px] px-[36px] gap-[20px] lg:gap-[100px] bg-[#3D52A0] sm:w-auto  '>
...
<div className='w-[1184px] h-[173px] gap-[24px] sm:w-[100%] sm:h-[250px] '>
        <div className='w-[1184px] h-[98px] gap-[16px] sm:w-[100%] sm:flex flex-col sm:items-center lg:flex lg:items-start  '>
          <Image alt='' width={134} height={34} src={Logoz} className='w-[134px] h-[34px] pb-2  sm:h-[100%]   '   />
          <p className='text-left w-[1184px] h-[48px] custo-font font-[400] text-[16px] leading-[24px] sm:w-[100%] sm:text-center lg:text-left '>We ara a lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat... <span className='text-[#4A61B5]'>Read More</span></p>
        </div>
        <div className='flex items-center w-[1184px] h-[51px] gap-[80px] pt-[30px] sm:pt-[110px] sm:flex  sm:items-center  sm:w-[700px] md:w-[900px] md:relative md:right-[2rem] sm:relative sm:right-[7rem] xl:flex xl:relative xl:left-[6rem]'>
          ...
          <div className='flex w-[236px] w-fill h-fill h-[51px] gap-[12px] sm:flex sm:items-center sm:relative sm:right-[100px] sm:w-[180px] lg:left-[5px] md:w-[200px] md:pl-[60px] '>
          ...
          <div className='flex w-[236px] w-fill h-fill h-[51px] gap-[12px] sm:flex sm:items-center sm:relative sm:right-[170px] sm:w-[180px] lg:left-[2px] md:w-[200px] md:pl-[60px]  xl:mr-[2rem]  '>
          ...
          <div className='flex justify-evenly w-[236px] w-fill h-fill h-[51px] gap-[18px] pl-8 sm:hidden lg:block  lg:flex  lg:ml-[2rem]  '>
      ...
      <div className='flex w-[1184px] h-[272px] justify-between sm:flex sm:justify-evenly sm:w-[900px] md:w-[1100px] lg:flex lg:justify-between lg:pt-4  '>

      <div className='w-[137.33px] h-[248px] flex flex-col gap-[24px] sm:relative sm:left-[9rem] lg:relative lg:left-[5rem]'>
      <p className='flex text-[#191D23]  w-[137.33px] h-[24px] custo-font font-[500] text-[16px] leading-[24px] '>About</p>
        ...
        <div className='w-[137.33px] h-[248px] flex flex-col gap-[24px] sm:relative sm:left-[5.3rem] lg:relative lg:left-[3rem] '>
        ...
        <div className='w-[137.33px] h-[272px] flex flex-col  gap-[24px] sm:relative sm:left-[3.8rem] lg:relative lg:left-[3rem]'>
        ...
        <div className='w-[137.33px] h-[248px] flex flex-col  gap-[24px] sm:relative sm:left-[1rem] lg:relative lg:left-[2rem]'>
        <p className='flex text-[#191D23]  w-[137.33px] h-[24px] custo-font font-[500] text-[16px] leading-[24px] '>About</p>
        <div className=' w-[137.33px] h-[200px] flex flex-col gap-[20px] '>
        <p className='flex w-[137.33px] h-[24px] text-[#4B5768] custo-font font-[500] text-[16px] leading-[24px]  '>About us</p>
        <p className='flex w-[137.33px] h-[24px] text-[#4B5768] custo-font font-[500] text-[16px] leading-[24px]  '>Blog</p>
        ...
        <div className='w-[137.33px] h-[248px] flex flex-col gap-[24px] sm:relative sm:right-[3.2rem] lg:relative lg:right-[2rem]'>
        <p className='flex text-[#191D23]  w-[137.33px] h-[24px] custo-font font-[500] text-[16px] leading-[24px] '>Support</p>
        <div className=' w-[137.33px] h-[200px] flex flex-col gap-[20px] '>
        <p className='flex w-[137.33px] h-[24px] text-[#4B5768] custo-font font-[500] text-[16px] leading-[24px]  '>Contact us</p>
        ...
        <div className='w-[137.33px] h-[272px] flex flex-col gap-[24px] sm:relative sm:right-[5rem] lg:relative lg:left-[1rem]'>
        <p className='flex text-[#191D23]  w-[137.33px] h-[24px] custo-font font-[500] text-[16px] leading-[24px] '>FAQ</p>
        <div className=' w-[137.33px] h-[200px] flex flex-col gap-[20px] '>
        <p className='flex w-[137.33px] h-[24px] text-[#4B5768] custo-font font-[500] text-[16px] leading-[24px]  '>Account</p>
