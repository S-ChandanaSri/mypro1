...
export default function RoomViewPage() {
  return (
    <>
      ...
      <div className="bg-[#F6F9FF] h-[977px] flex flex-col items-center rounded-[4px] py-[92px] px-[128px] gap-[56px] w-full ">
        <div className="flex flex-col md:flex-row w-full max-w-[1184px] h-auto md:h-[108px] rounded-[12px] py-[16px] md:py-[28px] px-[20px] md:px-[36px] gap-[20px] md:gap-[100px] bg-[#3D52A0] ">
          <div className="w-full md:w-[645px] h-auto md:h-[52px] gap-[4px]">
